...
import {type IDockerContainer, type  IMachine, type IMachineUsage } from "./types/machines";
...
export type GetAllContainers = APIResponse<IDockerContainer[]>
...
const BASE_URL = "http://100.123.44.57:5000";
